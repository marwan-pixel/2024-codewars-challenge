/*
Codewars 6 Kyu Check Digits
URL: https://www.codewars.com/kata/568d1ee43ee6afb3ad00001d
...
function addCheckDigit(number) {
    ...
    let productSum = result.reduce((accu, curr) => accu + curr);
    let remainder = productSum % 11;
    let digit = 11;
    remainder == 0 ? digit = 0 : remainder == 1 ? digit = 'X' : digit -= remainder;
    return number + digit;
}

console.log(addCheckDigit("111111111"));